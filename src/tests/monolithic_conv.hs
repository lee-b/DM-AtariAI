-- A benchmark where we see if a packing 16 arrays that 
-- need to be convoled with a filter into one large array
-- with 0's in the borders will run faster then 16 seq
-- convolutions

-- layer 1
-- four 84x84 signals convolved with fltr 8x8
-- monolithic signal 84 x 84 + 3 * (84 + 8) = 84 x 348
...
-- layer 2
-- sixteen 20x20 convolved with flt 4x4
-- monolithic signal 20 x 20 + 15 * (20 + 4) = 20 x 380
